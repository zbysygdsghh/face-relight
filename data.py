...
def get_test_set(test_dir):
    ...
    test_image_dir = test_dir + "/backlit_face"
    test_image_darkc_dir = test_dir + "/backlit_face_darkc"
    test_target_dir = test_dir + "/target_face"
    test_target_darkc_dir = test_dir + "/target_face_darkc"
...
def get_test_image_set(test_dir):
    ...
    return DatasetFromFolderTestImage(test_image_dir)
